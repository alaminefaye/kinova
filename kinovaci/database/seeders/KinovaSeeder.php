    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'sizes' => [
                    ['name' => '100 ml', 'stock' => 25],
                    ['name' => '200 ml', 'stock' => 25],
                ],
                'is_featured' => false,
                'is_new' => false,
                'rating' => 4.6,
            ...
            [
                ...
                'sizes' => [
                    ['name' => 'Standard (3.5g)', 'stock' => 30],
                    ['name' => 'Mini Format (1.5g)', 'stock' => 0],
                ],
                'colors' => [
                    ['name' => 'Terracotta Signature', 'hex' => '#C2410C', 'stock' => 15],
                    ['name' => 'Rouge Carmin', 'hex' => '#DC2626', 'stock' => 10],
                    ['name' => 'Rose Poudré', 'hex' => '#F472B6', 'stock' => 0],
                    ['name' => 'Nude Chaud', 'hex' => '#D97706', 'stock' => 5],
                ],
                'is_featured' => true,
                'is_new' => true,
                'rating' => 4.8,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Sable Doré', 'hex' => '#D4A373', 'stock' => 8],
                    ['name' => 'Noir Intense', 'hex' => '#1F2937', 'stock' => 7],
                    ['name' => 'Cognac Vintage', 'hex' => '#92400E', 'stock' => 0],
                ],
                'is_featured' => true,
                'is_new' => false,
                'rating' => 4.8,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Taupe Doux', 'hex' => '#8B8589', 'stock' => 10],
                    ['name' => 'Beige Crème', 'hex' => '#F5F5DC', 'stock' => 10],
                    ['name' => 'Gris Perle', 'hex' => '#E5E7EB', 'stock' => 0],
                ],
                'is_featured' => false,
                'is_new' => true,
                'rating' => 4.8,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Ivoire Pur', 'hex' => '#FFFFF0', 'stock' => 5],
                    ['name' => 'Champagne Rosé', 'hex' => '#F7E7CE', 'stock' => 3],
                ],
                'is_featured' => true,
                'is_new' => true,
                'rating' => 4.9,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Beige Sable', 'hex' => '#C8AD7F', 'stock' => 8],
                    ['name' => 'Bleu Nuit', 'hex' => '#1E293B', 'stock' => 4],
                ],
                'is_featured' => true,
                'is_new' => false,
                'rating' => 4.7,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Sable Doré', 'hex' => '#D4A373', 'stock' => 10],
                    ['name' => 'Noir Chic', 'hex' => '#1F2937', 'stock' => 8],
                    ['name' => 'Blanc Écru', 'hex' => '#FDFBF7', 'stock' => 0],
                ],
                'is_featured' => false,
                'is_new' => true,
                'rating' => 4.5,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Champagne', 'hex' => '#F7E7CE', 'stock' => 12],
                    ['name' => 'Bronze Doré', 'hex' => '#CD7F32', 'stock' => 10],
                    ['name' => 'Noir Soyeux', 'hex' => '#111827', 'stock' => 0],
                ],
                'is_featured' => false,
                'is_new' => true,
                'rating' => 4.6,
            ...
            [
                ...
                'sizes' => [
                    ['name' => '180g (45h)', 'stock' => 35],
                    ['name' => '350g (80h)', 'stock' => 25],
                    ['name' => 'Coffret 3x70g', 'stock' => 0],
                ],
                'is_featured' => false,
                'is_new' => true,
                'rating' => 4.7,
            ...
            [
                ...
                'sizes' => [
                    ['name' => '100 ml (8 sem.)', 'stock' => 18],
                    ['name' => '250 ml (20 sem.)', 'stock' => 10],
                ],
                'is_featured' => false,
                'is_new' => true,
                'rating' => 4.6,
            ...
            [
                ...
                'sizes' => [
                    ['name' => '45 × 45 cm', 'stock' => 25],
                    ['name' => '60 × 60 cm', 'stock' => 15],
                ],
                'colors' => [
                    ['name' => 'Doré Champagne', 'hex' => '#E5C158', 'stock' => 20],
                    ['name' => 'Vert Émeraude', 'hex' => '#065F46', 'stock' => 10],
                    ['name' => 'Terracotta', 'hex' => '#9A3412', 'stock' => 10],
                ],
                'is_featured' => false,
                'is_new' => false,
                'rating' => 4.5,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Or Rose 18k', 'hex' => '#E8B4B8', 'stock' => 15],
                    ['name' => 'Or Jaune 18k', 'hex' => '#E5C158', 'stock' => 10],
                    ['name' => 'Argent 925', 'hex' => '#E5E7EB', 'stock' => 0],
                ],
                'is_featured' => true,
                'is_new' => false,
                'rating' => 4.9,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Cuir Cognac', 'hex' => '#92400E', 'stock' => 7],
                    ['name' => 'Cuir Noir', 'hex' => '#1F2937', 'stock' => 5],
                    ['name' => 'Cuir Caramel', 'hex' => '#D97706', 'stock' => 0],
                ],
                'is_featured' => true,
                'is_new' => false,
                'rating' => 4.9,
            ...
            [
                ...
                'colors' => [
                    ['name' => 'Or Rose / Verres Bruns', 'hex' => '#C8AD7F', 'stock' => 12],
                    ['name' => 'Or Jaune / Verres Noirs', 'hex' => '#1F2937', 'stock' => 10],
                ],
                'is_featured' => false,
                'is_new' => true,
                'rating' => 4.7,
